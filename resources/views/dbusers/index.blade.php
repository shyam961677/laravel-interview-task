            ...
            @if($users->count())
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>{{ $user->role }}</td>
                        <td>
                            <a class="btn btn-info btn-sm" href="{{ route('dbusers.show', $user->id) }}">Show</a>
                            <a class="btn btn-warning btn-sm" href="{{ route('dbusers.edit', $user->id) }}">Edit</a>
                            <form action="{{ route('dbusers.destroy', $user->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure to delete?');">
                                @csrf
                                @method('DELETE')
